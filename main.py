...
from package.load import datamart, insert_data_dim_traveler, insert_data_dim_transpotation, insert_data_dim_accommodation, insert_data_dim_destination, insert_data_dim_time, insert_data_fact_trip
